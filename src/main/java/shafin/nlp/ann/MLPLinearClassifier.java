...
public class MLPLinearClassifier {
	...
	public MLPLinearClassifier(String trainFilePath, String testFilePath) {
	...
	public MultiLayerNetwork train() throws IOException, InterruptedException {
		...
		MultiLayerConfiguration conf = getDeepDenseLayerNetworkConfiguration(); //neural network banaisi
	...
	public Evaluation test(MultiLayerNetwork model) throws IOException, InterruptedException {
		DataSetIterator testIter = getDatasetIterator(TEST_FILE, batchSize);
